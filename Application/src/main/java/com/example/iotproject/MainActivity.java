...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        camera_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cameraTakePhotoAction();
                TextView textView = findViewById(R.id.textView);
                textView.setText("When confirmed, press Predict!");
            }
        });
        ...
        gallery_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent pickPhotoAction = new Intent(Intent.ACTION_PICK, android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
                startActivityForResult(pickPhotoAction, 1);
                TextView textView = findViewById(R.id.textView);
                textView.setText("When confirmed, press Predict!");
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == 1) {
                ...
                pathToFile = getFilePath(selectedPhoto);
                try {
    ...
    private void cameraTakePhotoAction() {
    ...
    private void uploadPicture() {
        ...
        UploadPic uploadPic = retrofit.create(UploadPic.class);
        Call<String> call = uploadPic.uploadPicture(parts);
